...
$app->get('/', function (Request $request, Response $response, array $args) {
  ...
  return $response->write(file_get_contents("/var/www/html/antidote_apache/contribute/stripe3/client" . '/index.html'));
});
...
$app->post('/stripe3/server/php/', function (Request $request, Response $response, array $args) {
    $pub_key = getenv('pk_live_9k64gXcOwdE12HvlcHZzTcsl00yhnsNQRo');
