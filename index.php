...
<div class="foods container-fluid" >
  ...
  <div class="row">
    <div class="col-md-3">
     <input type="text" value="<?=$_SESSION["s"]?>" name="s" id="s" size="35" placeholder="Find Recipes Search by food or Vitamin" onkeyup="getpage('/admin/ajax/recipe_search.php?s='+this.value);event.cancelBubble = true;"> 
     </div>
     <div class="col-md-3">
